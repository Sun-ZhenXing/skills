...
describe('init command', () => {
  ...
  it('should initialize a skill and create SKILL.md', () => {
    ...
    expect(output).toMatchInlineSnapshot(`
      ...
      Publishing:
        GitHub:  Push to a repo, then npx @alexsun-top/skills add <owner>/<repo>
        URL:     Host the file, then npx @alexsun-top/skills add https://example.com/my-test-skill/SKILL.md
  ...
  it('should init SKILL.md in cwd when no name provided', () => {
    ...
    expect(output).toContain('npx @alexsun-top/skills add <owner>/<repo>');
    expect(output).toContain('URL:');
    expect(output).toContain('npx @alexsun-top/skills add https://example.com/SKILL.md');
  ...
  it('should show publishing hints with skill path', () => {
    ...
    expect(output).toContain(
      'URL:     Host the file, then npx @alexsun-top/skills add https://example.com/my-skill/SKILL.md'
    );
  });
