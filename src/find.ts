...
${DIM}  1) npx @alexsun-top/skills find [query]${RESET}
${DIM}  2) npx @alexsun-top/skills add <owner/repo@skill>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx @alexsun-top/skills add <owner/repo@skill>`);
    console.log();
