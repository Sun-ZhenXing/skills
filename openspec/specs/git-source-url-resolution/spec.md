# Git Source URL Resolution Specification

## Purpose

Define how the skills CLI handles git repository source URLs during lock file restoration, including shorthand format conversion and reference preservation.
